...
This template supports building Flatpak packages for your .NET application.
...
```bash
flatpak install --user build-flatpak/org.example.dotnetdevshell.flatpak
flatpak run org.example.dotnetdevshell
```
